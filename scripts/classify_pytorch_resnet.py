...
def load_resnet_model(model_path, num_classes=2, device=None):
    """
    Load a ResNet50 model from a .pth file.
    Args:
...
def predict_image(model, image_path, device=None):
    """
    Predict the class and probabilities for a single image using a loaded model.
    Args:
